...
namespace GlucoMan
{
    internal static class TextFile
    {
        ...
        /// <returns></returns>
        internal static string[,] FileToMatrix(string NomeFile, char Separatore, out string[] primaRiga, out string[] secondaRiga)
        {
            int nLine = 0;
            string Line;
            string[,] MatriceFile = new string[0, 0]; // inizializzazione fittizia, quella buona dopo
        ...
        internal static string[,] FileToMatrix(string NomeFile, string Separatore)
        ...
        /// <returns>Vero se tutto è andato bene</returns>
        internal static bool MatrixToFile(string NomeFile, string[,] Matrix, char Separatore, string[] primaRiga, bool appendi)
        {   /// scrive riga per riga un array di stringhe in un file di testo
