...
namespace GlucoMan
{
    public static partial class Common
    {
        ...
        public static void SetGlobalParameters()
        {
            ...
            // 
            string PathGlucoMan = Path.Combine(PathUser, "GlucoMan");
            PathConfigurationData = Path.Combine(PathGlucoMan, "Config");
            PathProgramsData = Path.Combine(PathGlucoMan, "Data");
            //PathProgramsData = Path.Combine(Common.LocalApplicationPath, @"Data");
            PathLogs = Path.Combine(PathGlucoMan, "Logs");
            // PathLogs = Path.Combine(Common.LocalApplicationPath, @"Logs");
            PathDatabase = Path.Combine(PathGlucoMan, "Data");
            ...
            PathImportExport = Path.Combine(PathGlucoMan, "ImportExport");
