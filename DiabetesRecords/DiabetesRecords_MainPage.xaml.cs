...
namespace DiabetesRecords
{
    public partial class MainPage : CarouselPage
    {
        ...
        private async void btnSaveRecord_ClickAsync(object sender, EventArgs e)
        {
            ...
            {
                await DisplayAlert("Prima di salvare scegliere una riga dalla lista sotto", "Scegliere i dati da salvare", "Ok");
                return;
            }
            FromUiToClass();
        ...
        private async void btnRemoveRecord_ClickAsync(object sender, EventArgs e)
        {
            if (txtIdDiabetesRecord.Text == "")
            {
                await DisplayAlert("Scegliere dalla lista una riga da cancellare", "Scegliere i dati da eliminare", "Ok");
                return;
            }
