...
public partial class HandsPicturePage : ContentPage
{
    ...
    public HandsPicturePage(ref Injection currentInjection)
	{
        InitializeComponent();
        ...
        allCircles.Type = CirclesDrawable.PointType.Hands;
        ...
        //   DateTime.Now, Zone: Common.ZoneOfPosition.Hands);

        //// copy the coordinates of the hand punctures into the Drawable object
    ...
    private void LoadTheReferencePositions()
    {
        ...
        allReferencePositions = bl.GetReferencePositions(Common.ZoneOfPosition.Hands);
    ...
    {
        allCircles.ClearAll(Common.ZoneOfPosition.Hands);
        this.cerchiGraphicsView.Invalidate();
    }
    private void BtnSaveReferencePoints_Clicked(object sender, EventArgs e)
    {
        allCircles.SaveReferenceCoordinates(Common.ZoneOfPosition.Hands
