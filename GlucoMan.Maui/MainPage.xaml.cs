    ...
    public partial class MainPage : ContentPage
    {
        ...
        private async Task InitializeAsync()
        {
            try
            {
                ...
                try
                {
                    Common.breakfastStartHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Breakfast_StartTime_Hours"));
                    Common.breakfastEndHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Breakfast_EndTime_Hours"));
                    Common.lunchStartHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Lunch_StartTime_Hours"));
                    Common.lunchEndHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Lunch_EndTime_Hours"));
                    Common.dinnerStartHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Dinner_StartTime_Hours"));
                    Common.dinnerEndHour = Safe.Double(BlGeneral.RestoreParameter("Meal_Dinner_EndTime_Hours"));

                    // Load CantSetAlarms parameter
                    string CantSetAlarmsValue = BlGeneral.RestoreParameter("CantSetAlarms");
